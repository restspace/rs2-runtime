// @generated by rs2-worker/scripts/gen-media-types.mjs from mime-db 1.53.0
// (IANA + Apache + nginx; MIT). Do not edit: run `npm run gen:media-types`
// in rs2-worker/ and commit both hosts' tables together.
//
// The extension map, generated for both hosts from one source so they
// cannot disagree about what a client is served. The hand-written half

...
That's querying. Part 7 moves from *reading* data to *composing* services into
multi-step flows: pipelines.

---

← [Previous: 6.4 String/SQL templates](6.4-string-sql-templates.md) · [Manual home](../README.md) · [Next: Part 7 — 7.1 The pipeline service →](../part-7-pipelines/7.1-the-pipeline-service.md)
